...
# from matcha.data.text_mel_datamodule_weight_wav2vec import TextMelDataModule
...
@hydra.main(version_base="1.3", config_path="../configs", config_name="train_weight_wav2vec_dynamic.yaml")
